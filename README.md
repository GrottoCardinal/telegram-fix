...
**[GrottoCardinal/telegram-fix](https://github.com/GrottoCardinal/telegram-fix)** — сборка для Windows 10/11

[**⬇ Скачать последний релиз**](https://github.com/GrottoCardinal/telegram-fix/releases/latest)
...
> Если вы наткнулись на что-то вне репозитория `GrottoCardinal/telegram-fix`, что распространяется от моего лица — **ФЕЙК**.
...
1. Откройте [**Releases → Latest**](https://github.com/GrottoCardinal/telegram-fix/releases/latest) и скачайте **`.rar`** (предпочтительно)
